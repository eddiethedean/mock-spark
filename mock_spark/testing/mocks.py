...
from mock_spark.dataframe import MockDataFrame, MockDataFrameWriter, MockGroupedData, MockRDD
from mock_spark.functions import MockColumn, MockFunctions
from mock_spark.spark_types import MockStructType, MockStructField, StringType, IntegerType, LongType, DoubleType, BooleanType
...
class MockDataFrameFactory:
    ...
    @staticmethod
    def create_dataframe_with_schema(session: MockSparkSession, schema: MockStructType, 
                                   data: List[Dict[str, Any]] = None) -> MockDataFrame:
...
class MockSessionFactory:
    ...
    @staticmethod
    def create_session_with_data(dataframes: Dict[str, MockDataFrame]) -> MockSparkSession:
...
class MockFunctionFactory:
    ...
    def create_literal(value: Any) -> MockColumn:
        ...
        return MockFunctions.lit(value)
    
    @staticmethod
    def create_arithmetic_expression(left: MockColumn, operator: str, right: MockColumn) -> MockColumn:
    ...
    @staticmethod
    def create_comparison_expression(left: MockColumn, operator: str, right: MockColumn) -> MockColumn:
...
def create_test_dataframe(session: MockSparkSession, 
                         data: List[Dict[str, Any]] = None,
                         schema: MockStructType = None) -> MockDataFrame:
