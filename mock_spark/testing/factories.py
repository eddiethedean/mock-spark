...
from mock_spark.spark_types import MockStructType, MockStructField, StringType, IntegerType, LongType, DoubleType, BooleanType, DateType, TimestampType
...
from .mocks import MockDataFrameFactory, MockSessionFactory, MockFunctionFactory, MockStorageFactory
...
class DataFrameTestFactory:
    ...
    @staticmethod
    def create_performance_test_dataframe(session: MockSparkSession, 
                                        num_rows: int = 10000,
                                        num_columns: int = 10) -> MockDataFrame:
    ...
    def create_stress_test_dataframe(session: MockSparkSession) -> MockDataFrame:
        ...
        data = [
            ...
            {"id": -1, "name": "Negative", "age": -1, "salary": -1000.0, "active": True},  # Negative values
    ...
    def create_window_test_dataframe(session: MockSparkSession) -> MockDataFrame:
        ...
        data = [
            {"id": 1, "name": "Alice", "department": "Engineering", "salary": 80000.0, "hire_date": "2020-01-15"},
            {"id": 2, "name": "Bob", "department": "Engineering", "salary": 90000.0, "hire_date": "2019-06-10"},
            {"id": 3, "name": "Charlie", "department": "Marketing", "salary": 70000.0, "hire_date": "2021-03-20"},
            {"id": 4, "name": "David", "department": "Engineering", "salary": 85000.0, "hire_date": "2020-11-05"},
            {"id": 5, "name": "Eve", "department": "Marketing", "salary": 75000.0, "hire_date": "2021-08-12"},
            {"id": 6, "name": "Frank", "department": "Sales", "salary": 65000.0, "hire_date": "2022-01-30"},
        ]
...
class SessionTestFactory:
    ...
    @staticmethod
    def create_session_with_tables(session: MockSparkSession, 
                                 table_configs: Dict[str, Dict[str, Any]]) -> MockSparkSession:
    ...
    @staticmethod
    def create_session_with_configs(session: MockSparkSession, 
                                  configs: Dict[str, str]) -> MockSparkSession:
    ...
    @staticmethod
    def create_session_with_storage_data(session: MockSparkSession,
                                       storage_data: Dict[str, List[Dict[str, Any]]]) -> MockSparkSession:
