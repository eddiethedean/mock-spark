...
class WindowFunctionProcessor:
    ...
    def window_function_to_orm(self, table_class: Any, window_func: Any) -> Any:
        ...
        Args:
            table_class: SQLAlchemy table class
            window_func: Window function to convert

        Returns:
            SQLAlchemy ORM expression
        """
    ...
    def window_spec_to_sql(self, window_spec: Any, table_obj: Any) -> str:
        ...
        Args:
            ...
            table_obj: Table object for column validation

        Returns:
            SQL string representation of window specification
        """
        return self.expression_translator.window_spec_to_sql(window_spec, table_obj)
