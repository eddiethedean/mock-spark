...
class SQLQueryBuilder:
    ...
    def build_case_when_sql(self, case_when_obj: Any, source_table_obj: Any) -> str:
        ...
        for condition, value in case_when_obj.conditions:
            ...
            if isinstance(condition, MockColumnOperation):
                ...
                condition_sql = self.sql_converter.condition_to_sql(condition, source_table_obj)
    ...
    def build_with_column_cte(
        ...
        Returns:
            SQL query string
        """
        return self.cte_builder.build_with_column_cte(source_name, col_name, col, source_table_obj)
    ...
    def build_limit_cte(
        ...
        Returns:
            SQL query string
        """
        return self.cte_builder.build_limit_cte(source_name, limit_count, source_table_obj)
