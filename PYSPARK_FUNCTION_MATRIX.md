...
- **Conditional Functions**: Fixed `when/otherwise` expressions to be handled by Polars backend for better performance
- **Conditional Functions**: Fixed `isin` to correctly handle column expressions and literals
- **Date/Time Functions**: Fixed `date_format`, `datediff`, `day` extraction, and timestamp casting
- **Date/Time Functions**: Improved string-to-numeric casting for decimal strings like '10.5'
- **Array Functions**: Enhanced `array_join`, `array_sort`, `arrays_zip`, `flatten`, `sequence`, `array`
- **Map Functions**: Enhanced `map_from_arrays`, `map_from_entries`, `create_map`
- **Special Functions**: Implemented `hash` (MurmurHash3) and `overlay` functions
- **Type Casting**: Fixed array and map casting to string types, date/timestamp casting to/from strings

### Window Functions
- **Complex Ordering**: Fixed window functions to support multiple order columns with different directions (asc/desc)
- **Window Frames**: Implemented support for `rowsBetween` and `rangeBetween` window frames
...
| `sha1` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `sha2` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `shiftLeft` | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ |
| `shiftRight` | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ |
| `shiftRightUnsigned` | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ | ⚠️ |
| `shiftleft` | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `shiftright` | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `shiftrightunsigned` | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ |
| `shuffle` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
