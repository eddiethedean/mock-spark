...
class TestWindowFunctionsExtendedCompatibility:
    ...
    @pytest.mark.skip(reason="first_value window function not yet implemented correctly")
    ...
    @pytest.mark.skip(reason="percent_rank window function not yet implemented correctly")
