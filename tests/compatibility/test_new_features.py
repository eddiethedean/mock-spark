...
class TestArithmeticOperations:
    ...
    def test_addition_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_subtraction_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test subtraction operation (col - value)."""
        mock_result = mock_dataframe.select(mock_functions.col("age") - 1)
        pyspark_result = pyspark_dataframe.select(pyspark_functions.col("age") - 1)
        assert_dataframes_equal(mock_result, pyspark_result)
    
    def test_multiplication_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_division_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_modulo_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestAggregationFunctions:
    ...
    def test_count_distinct_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestDataFrameMethods:
    ...
    def test_asc_ordering(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestLiteralFunctions:
    ...
    def test_lit_with_integer(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_lit_with_string(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_lit_with_float(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestRegressionPrevention:
    ...
    def test_basic_select_still_works(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_basic_filter_still_works(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_basic_groupby_still_works(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
