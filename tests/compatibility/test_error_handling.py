...
class TestErrorHandling:
    ...
    def test_invalid_arithmetic_operation(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_null_handling_in_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestEdgeCases:
    ...
    def test_very_large_numbers(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_very_small_numbers(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_unicode_strings(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_very_long_strings(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_boolean_edge_cases(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestSchemaEdgeCases:
    ...
    def test_duplicate_column_names(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_empty_column_names(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test handling of empty column names."""
        try:
            mock_result = mock_dataframe.select(
                mock_functions.lit("value").alias("")
            )
            pyspark_result = pyspark_dataframe.select(
    ...
    def test_special_character_column_names(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestPerformanceEdgeCases:
    ...
    def test_many_columns(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_deep_nested_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_chained_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        ...
        for i in range(10):
            result = result.select(
                mock_functions.col("*"),
                mock_functions.lit(i).alias(f"iteration_{i}")
            )
