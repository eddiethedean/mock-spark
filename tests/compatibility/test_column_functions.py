...
class TestColumnFunctions:
    ...
    def test_col_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test col() function."""
    ...
    def test_lit_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test lit() function."""
    ...
    def test_lit_function_with_existing_column(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_lit_function_different_types(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_lit_function_column_naming(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_col_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_arithmetic_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_logical_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_null_check_operations(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
...
class TestAggregateFunctions:
    ...
    def test_count_function_with_star(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test count("*") function."""
        mock_result = mock_dataframe.select(mock_functions.count("*"))
        pyspark_result = pyspark_dataframe.select(pyspark_functions.count("*"))
        assert_dataframes_equal(mock_result, pyspark_result)
    
    def test_count_with_column(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_count_column_naming_compatibility(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
    ...
    def test_groupby_count_method_vs_agg_compatibility(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        ...
        pyspark_result_agg = pyspark_dataframe.groupBy("department").agg(pyspark_functions.count("*"))
    ...
    def test_sum_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test sum() function."""
    ...
    def test_avg_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test avg() function."""
    ...
    def test_max_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test max() function."""
    ...
    def test_min_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test min() function."""
...
class TestWindowFunctions:
    ...
    def test_row_number_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions, mock_types, pyspark_types):
        ...
        try:
            ...
            pytest.skip("Window functions not implemented in mock_spark yet")


class TestStringFunctions:
    """Test string functions compatibility."""
    
    def test_upper_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test upper() function."""
        mock_result = mock_dataframe.select(mock_functions.upper(mock_functions.col("name")))
        pyspark_result = pyspark_dataframe.select(pyspark_functions.upper(pyspark_functions.col("name")))
        assert_dataframes_equal(mock_result, pyspark_result)
    
    def test_lower_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test lower() function."""
        mock_result = mock_dataframe.select(mock_functions.lower(mock_functions.col("name")))
        pyspark_result = pyspark_dataframe.select(pyspark_functions.lower(pyspark_functions.col("name")))
        assert_dataframes_equal(mock_result, pyspark_result)
    
    def test_length_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test length() function."""
        mock_result = mock_dataframe.select(mock_functions.length(mock_functions.col("name")))
        pyspark_result = pyspark_dataframe.select(pyspark_functions.length(pyspark_functions.col("name")))
        assert_dataframes_equal(mock_result, pyspark_result)
...
class TestMathematicalFunctions:
    ...
    def test_abs_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test abs() function."""
        # Create a DataFrame with negative values
        mock_data_with_neg = mock_dataframe.withColumn("age_neg", mock_functions.col("age") * -1)
        pyspark_data_with_neg = pyspark_dataframe.withColumn("age_neg", pyspark_functions.col("age") * -1)
        
        mock_result = mock_data_with_neg.select(mock_functions.abs(mock_functions.col("age_neg")))
        pyspark_result = pyspark_data_with_neg.select(pyspark_functions.abs(pyspark_functions.col("age_neg")))
        assert_dataframes_equal(mock_result, pyspark_result)
    
    def test_round_function(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
        """Test round() function."""
        mock_result = mock_dataframe.select(mock_functions.round(mock_functions.col("salary"), 2))
        pyspark_result = pyspark_dataframe.select(pyspark_functions.round(pyspark_functions.col("salary"), 2))
        assert_dataframes_equal(mock_result, pyspark_result)
...
class TestFunctionDiscrepancyDetection:
    ...
    def test_operation_chaining(self, mock_dataframe, pyspark_dataframe, mock_functions, pyspark_functions):
