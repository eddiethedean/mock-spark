"""
Core tests for backend abstraction layer functionality.

This module tests the essential backend selection and configuration features
that demonstrate the backend abstraction layer is working correctly.
"""
