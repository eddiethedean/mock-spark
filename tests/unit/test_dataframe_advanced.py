...
class TestDataFrameAdvancedOperations:
    ...
    def complex_data(self):
        ...
        return [
            {"id": 1, "name": "Alice", "department": "Engineering", "salary": 80000.0, "bonus": 5000.0},
            {"id": 2, "name": "Bob", "department": "Engineering", "salary": 75000.0, "bonus": 3000.0},
            {"id": 3, "name": "Charlie", "department": "Marketing", "salary": 70000.0, "bonus": 4000.0},
            {"id": 4, "name": "Diana", "department": "Engineering", "salary": 85000.0, "bonus": 6000.0},
    ...
    def test_window_functions_with_range_between(self, spark, complex_data):
        ...
        window_spec = MockWindow.partitionBy("department").orderBy("salary").rangeBetween(-10000, 10000)
    ...
    def test_complex_filter_operations(self, spark, complex_data):
        ...
        result3 = df.filter(
            F.col("bonus").isNotNull() & (F.col("bonus") > 0)
        )
