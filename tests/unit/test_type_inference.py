...
class TestTypeInference:
    ...
    def test_primitive_type_inference(self, spark):
        ...
        assert isinstance(
            float_field.dataType, DoubleType
        )  # PySpark uses Double for float
    ...
    def test_binary_type_inference(self, spark):
        ...
        data = [{"binary_data": b"hello world"}, {"binary_data": b"test data"}]
    ...
    def test_all_null_column(self, spark):
        ...
        data = [{"value": 42, "null_col": None}, {"value": 100, "null_col": None}]
...
class TestTypeCasting:
    ...
    def test_decimal_casting(self, spark):
        ...
        data = [{"value": 3.14159}, {"value": 2.71828}]
    ...
    def test_safe_casting_with_invalid_values(self, spark):
        ...
        data = [{"value": "42"}, {"value": "invalid"}, {"value": "100"}]
    ...
    def test_complex_casting_expressions(self, spark):
        ...
        data = [{"value": 42.5, "flag": 1}, {"value": 100.7, "flag": 0}]
...
class TestAdvancedTypeHandling:
    ...
    def test_interval_types(self, spark):
        ...
        data = [{"year_month": None, "day_time": None, "interval": None}]
    ...
    def test_char_varchar_types(self, spark):
        ...
        data = [{"char_field": "test", "varchar_field": "longer string"}]
    ...
    def test_timestamp_ntz_type(self, spark):
        ...
        schema = MockStructType([MockStructField("timestamp_ntz", TimestampNTZType())])

        data = [{"timestamp_ntz": "2024-01-15 10:30:00"}]
    ...
    def test_nullable_handling(self, spark):
        ...
        data = [{"required": 42, "optional": 100}, {"required": 100, "optional": None}]
...
class TestTypeCastingEdgeCases:
    ...
    def test_casting_with_null_values(self, spark):
        ...
        data = [{"value": None, "string_val": "42"}, {"value": 100, "string_val": None}]
