...
class TestSchemaManager:
    ...
    def test_parse_cast_type_string_primitive_types(self):
        ...
        assert isinstance(SchemaManager.parse_cast_type_string("timestamp"), TimestampType)
    ...
    def test_project_schema_with_operations_filter(self):
        ...
        result_schema = SchemaManager.project_schema_with_operations(base_schema, operations)
    ...
    def test_project_schema_with_operations_withcolumn_literal(self):
        ...
        expected_schema = MockStructType([
            MockStructField("name", StringType()),
            MockStructField("constant_col", StringType(nullable=False), nullable=False)
        ])
        assert result_schema == expected_schema
